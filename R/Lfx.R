...
#' objects to easily generate portions of hypothesis matrices for complex models.
...
#' requires the intermediate step of creating a data frame with crossing factors to be difference with
